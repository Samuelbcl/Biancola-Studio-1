...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/audit`, lastModified, changeFrequency: "monthly", priority: 0.9 },
    { url: `${baseUrl}/services`, lastModified, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/services/outil-metier-sur-mesure`, lastModified, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/services/automatisation-pme`, lastModified, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/services/creation-site-internet-liege`, lastModified, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${baseUrl}/tarifs`, lastModified, changeFrequency: "monthly", priority: 0.6 },
